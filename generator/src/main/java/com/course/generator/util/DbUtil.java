...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/courseimooc?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC&autoReconnect=true";
    ...
    public static List<Field> getColumnByTableName(String tableName) throws Exception {
        ...
        if (rs != null) {
            while(rs.next()) {
                ...
                //为length复制  length>0 ，表示需要对length做校验；当length=0时，表示不需要校验
